    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-sm relative">
        <div className="text-center mb-8">
          ...
          <h1 className="text-foreground text-xl font-semibold">Accept your invite</h1>
          <p className="text-foreground-3 text-sm mt-1">Set up your VoxHire account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-surface border border-base rounded-2xl p-6 space-y-4">
          ...
          <div>
            <label className="block text-foreground-3 text-xs mb-2 font-medium">Your Name</label>
            <input
              type="text"
              value={form.name}
              onChange={set("name")}
          ...
          <div>
            <label className="block text-foreground-3 text-xs mb-2 font-medium">Set Password</label>
